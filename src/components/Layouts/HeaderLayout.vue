...
const classLayoutHeader = `w-full h-[60px] max-h-[60px] bg-[#2F363D] tex-white`
const headerJul = ` w-full h-full grid grid-cols-6  px-6 py-1   bg-[#24292E] tex-white`
...
const btnConfig = `bg-[#13B497] p-[8px] rounded-md`
const btnNotificacion = `bg-[#2F363D] p-2 rounded-lg relative `
const dotNotificacion = `w-3 h-3 bg-[#D9B75F] rounded-3xl absolute -top-[2px] -right-[2px]`
const btnMessage = `bg-[#2F363D] p-2 rounded-lg relative `
const dotMessage = `w-3 h-3 bg-[#D9B75F] rounded-3xl absolute -top-[2px] -right-[2px]`
const btngift = `bg-[#2F363D] p-2 rounded-lg relative `
...
const SearchSection = `flex col-span-2  items-center gap-2`


</script>
<template>
    <div :class="classLayoutHeader">
        <div :class="headerJul">
            ...
            <div :class="SearchSection">
                <div :class="wraperInputSearche">
                    <input type="text" :class="inputSearch" id="inputSearch" placeholder="Search here" />
                    <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" :class="SvgInputSearch">
                        <path
                ...
                <button :class="btnConfig">
                    <svg width="10px" height="10px" viewBox="0 0 28 28" fill="none">
            ...
            <div :class="NotificationSection">
                <button :class="btnNotificacion">
                    ...
                    <div :class="dotNotificacion" />
                </button>
                <button :class="btnMessage">
                    <svg width="26px" height="26px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 8H16M8 12H13M7 16V21L12 16H20V4H4V16H7Z" stroke="#13B497" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <div :class="dotMessage" />
                </button>
                <button :class="btngift">
                    <svg fill="#8D98A4" width="26px" height="26px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M15.5 6a1.25 1.25 0 0 0-1.25-1.25h-1.06a2.19 2.19 0 0 0 .23-1A2.22 2.22 0 0 0 11.2 1.5 3.78 3.78 0 0 0 8 3.07 3.78 3.78 0 0 0 4.8 1.5a2.22 2.22 0 0 0-2.22 2.22 2.19 2.19 0 0 0 .23 1H1.75A1.25 1.25 0 0 0 .5 6v2.5h1.25v4.79A1.25 1.25 0 0 0 3 14.5h10a1.25 1.25 0 0 0 1.25-1.25V8.46h1.25zm-4.3-3.25a1 1 0 0 1 0 2H8.68a2.36 2.36 0 0 1 2.52-2zm-6.4 0a2.36 2.36 0 0 1 2.52 2H4.8a1 1 0 0 1 0-1.95zM1.75 6h4.37v1.21H1.75zm4.37 7.29H3V8.46h3.12zm1.26 0V6h1.24v7.29zm5.62 0H9.88V8.46H13zm1.25-6H9.88V6h4.37z"/></svg>
                    <div :class="dotgift" />
                </button>
                
            </div>
            <div class="flex gap-4 justify-center items-center">
                <div class="flex gap-2 bg-[#EEFFF30A] rounded-lg" >
                    <div class="w-10 h-10 bg-[#D3D6E4] rounded-lg ">
                        
                    </div>
                    <span class="self-center" >Juliot</span>
